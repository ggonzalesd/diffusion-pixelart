...
from m_tools import batch_image_join, batch_image_split, batch_image_to_batch_sequential, batch_sequential_to_batch_image
...
if __name__ == '__main__':
  ...
  X = torch.randn(BATCH, 128, 32, 32) * 0.5
